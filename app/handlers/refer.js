...
const email = require(__base + '/app/modules/common/ses_sendemail');
...
module.exports.referpeople = async (req, res) => {
  try {
    ...
    const name =
      req.authInfo.tokenData.first_name +
      ' ' +
      req.authInfo.tokenData.last_name;
    ...
    await email.sendemail(req.request_id, name, emails, codes);
