...
module.exports.check = async function(req, res) {
  ...
  try {
    const [result1, result2, result3] = await Promise.all([
      mysql.query(req.request_id, profile_db, query, [], false),
      mysql.query(req.request_id, provisioning_db, query, [], false),
      mysql.query(req.request_id, promotion_db, query, [], false)
    ]);
